...
import (
	...
	"github.com/Gundy-Zhou/component/pkg/selection"
	"github.com/Gundy-Zhou/component/pkg/util/sets"
	"github.com/Gundy-Zhou/component/pkg/validation"
)
...
func (lsel internalSelector) DeepCopy() internalSelector {
	if lsel == nil {
		return nil
	}
	result := make([]Requirement, len(lsel))
	for i := range lsel {
		lsel[i].DeepCopyInto(&result[i])
	}
	return result
}

func (lsel internalSelector) DeepCopySelector() Selector {
	return lsel.DeepCopy()
}
